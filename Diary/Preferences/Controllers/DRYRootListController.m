#include "DRYRootListController.h"

@implementation DRYRootListController
...
- (void)viewDidLoad {
    ...
    self.preferences = [[HBPreferences alloc] initWithIdentifier:@"love.litten.diarypreferences"];
    ...
    [[self iconView] setImage:[UIImage imageWithContentsOfFile:jbroot(@"/Library/PreferenceBundles/DiaryPreferences.bundle/icon.png")]];
    ...
    [[self headerImageView] setImage:[UIImage imageWithContentsOfFile:jbroot(@"/Library/PreferenceBundles/DiaryPreferences.bundle/Banner.png")]];
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath:jbroot(@"/Library/MobileSubstrate/DynamicLibraries/Diary.disabled")]) {
...
- (void)resetPrompt {
    ...
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Diary" message:@"Do you really want to reset your preferences?" preferredStyle:UIAlertControllerStyleActionSheet];
...
- (void)resetPreferences {
    ...
    [[NSFileManager defaultManager] removeItemAtPath:jbroot(@"/var/mobile/Library/Preferences/love.litten.diarypreferences/") error:nil];
