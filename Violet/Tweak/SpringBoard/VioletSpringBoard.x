...
%group VioletLockScreenPlayer13

%hook MRPlatterViewController

- (void)viewDidAppear:(BOOL)animated { // add violet to the lock screen player (iOS 13)
...
- (void)viewDidAppear:(BOOL)animated { // add violet to the lock screen player (iOS 14)
...
%ctor {
	...
	if (lockscreenArtworkBackgroundSwitch || lockscreenPlayerArtworkBackgroundSwitch || homescreenArtworkBackgroundSwitch || controlCenterArtworkBackgroundSwitch || controlCenterModuleArtworkBackgroundSwitch) %init(VioletCompletion);
