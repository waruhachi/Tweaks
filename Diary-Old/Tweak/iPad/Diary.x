...
%new
- (void)updateFrameAfterRotation { // update gradient frame when rotated
...
- (void)didMoveToWindow { // remove faceid lock and label
	...
	if (hideDefaultFaceIDLockSwitch) {
        [[self superview] setHidden:YES];
        [[self valueForKey:@"_cameraCoveredView"] setHidden:YES];
    }
...
- (void)didMoveToWindow { // add time and date
    ...
    if (enableUpNextSwitch) {
        ...
        if (showCalendarEventButtonSwitch) {
            ...
            [NSLayoutConstraint activateConstraints:@[
                ...
                [self.diaryCalendarButton.leadingAnchor constraintEqualToAnchor:self.diaryView.leadingAnchor constant:24],
        ...
        if (showReminderButtonSwitch) {
            ...
            if (showCalendarEventButtonSwitch) {
                ...
                [NSLayoutConstraint activateConstraints:@[
                    [self.diaryReminderButton.bottomAnchor constraintEqualToAnchor:self.diaryView.bottomAnchor constant:-32.5],
                    [self.diaryReminderButton.leadingAnchor constraintEqualToAnchor:self.diaryView.leadingAnchor constant:24],
                    [self.diaryReminderButton.widthAnchor constraintEqualToConstant:21],
                    [self.diaryReminderButton.heightAnchor constraintEqualToConstant:21],
                ]];
            }
        ...
        if (showAlarmButtonSwitch) {
            ...
            if ((showCalendarEventButtonSwitch && showReminderButtonSwitch) || (!showCalendarEventButtonSwitch && showReminderButtonSwitch)) {
                ...
                [NSLayoutConstraint activateConstraints:@[
                    [self.diaryAlarmButton.bottomAnchor constraintEqualToAnchor:self.diaryView.bottomAnchor constant:-32.5],
                    [self.diaryAlarmButton.leadingAnchor constraintEqualToAnchor:self.diaryView.leadingAnchor constant:24],
                    [self.diaryAlarmButton.widthAnchor constraintEqualToConstant:21],
                    [self.diaryAlarmButton.heightAnchor constraintEqualToConstant:21],
                ]];
            }
    ...
    if (enableUpNextSwitch || showWeatherSwitch) {
        ...
        else if ([fontFamilyValue intValue] == 1) [[self diaryEventSubtitleLabel] setFont:[UIFont fontWithName:@"OpenSans-Regular" size:20]];
        else if ([fontFamilyValue intValue] == 2) [[self diaryEventSubtitleLabel] setFont:[UIFont systemFontOfSize:20 weight:UIFontWeightRegular]];
        ...
        else if ([fontFamilyValue intValue] == 1) [[self diaryEventTitleLabel] setFont:[UIFont fontWithName:@"OpenSans-Regular" size:20]];
        else if ([fontFamilyValue intValue] == 2) [[self diaryEventTitleLabel] setFont:[UIFont systemFontOfSize:20 weight:UIFontWeightRegular]];
        ...
        [NSLayoutConstraint activateConstraints:@[
            [self.diaryEventTitleLabel.leadingAnchor constraintEqualToAnchor:self.diaryView.leadingAnchor constant:24],
    ...
    if ([overrideTimeDateStyleValue intValue] == 0) {
        ...
        else if ([fontFamilyValue intValue] == 1) [[self diaryDateLabel] setFont:[UIFont fontWithName:@"OpenSans-Regular" size:40]];
        else if ([fontFamilyValue intValue] == 2) [[self diaryDateLabel] setFont:[UIFont systemFontOfSize:40 weight:UIFontWeightRegular]];
        ...
        else if ([fontFamilyValue intValue] == 1) [[self diaryTimeLabel] setFont:[UIFont fontWithName:@"OpenSans-Light" size:105]];
        else if ([fontFamilyValue intValue] == 2) [[self diaryTimeLabel] setFont:[UIFont systemFontOfSize:105 weight:UIFontWeightLight]];
    ...
    if (showBatteryIconSwitch) {
        ...
        [NSLayoutConstraint activateConstraints:@[
            [self.diaryBatteryIcon.trailingAnchor constraintEqualToAnchor:self.diaryView.trailingAnchor constant:-24],
    ...
    if (showWifiIconSwitch) {
        ...
        if (showBatteryIconSwitch) {
            ...
            [[self diaryWifiIcon] setTranslatesAutoresizingMaskIntoConstraints:NO];
            [NSLayoutConstraint activateConstraints:@[
                [self.diaryWifiIcon.trailingAnchor constraintEqualToAnchor:self.diaryView.trailingAnchor constant:-24],
                [self.diaryWifiIcon.bottomAnchor constraintEqualToAnchor:self.diaryView.bottomAnchor constant:-32.5],
                [self.diaryWifiIcon.widthAnchor constraintEqualToConstant:20],
                [self.diaryWifiIcon.heightAnchor constraintEqualToConstant:20],
            ]];
    ...
    if (showCellularIconSwitch) {
        ...
        if ((showBatteryIconSwitch && showWifiIconSwitch) || (showWifiIconSwitch && showCellularIconSwitch)) {
            ...
            [[self diaryCellularIcon] setTranslatesAutoresizingMaskIntoConstraints:NO];
            [NSLayoutConstraint activateConstraints:@[
                [self.diaryCellularIcon.trailingAnchor constraintEqualToAnchor:self.diaryView.trailingAnchor constant:-24],
                [self.diaryCellularIcon.bottomAnchor constraintEqualToAnchor:self.diaryView.bottomAnchor constant:-31],
                [self.diaryCellularIcon.widthAnchor constraintEqualToConstant:22],
                [self.diaryCellularIcon.heightAnchor constraintEqualToConstant:22],
            ]];
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, 1 * NSEC_PER_SEC), dispatch_get_main_queue(), ^{
        ...
        if (enableUpNextSwitch || showWeatherSwitch) {
            if (![[[self diaryEventTitleLabel] text] isEqualToString:@""]) {
                ...
                [[self diaryDateLabel] setTranslatesAutoresizingMaskIntoConstraints:NO];
                [NSLayoutConstraint activateConstraints:@[
                    [self.diaryDateLabel.leadingAnchor constraintEqualToAnchor:self.diaryView.leadingAnchor constant:24],
                ...
                [[self diaryTimeLabel] setTranslatesAutoresizingMaskIntoConstraints:NO];
                [NSLayoutConstraint activateConstraints:@[
                    [self.diaryTimeLabel.leadingAnchor constraintEqualToAnchor:self.diaryView.leadingAnchor constant:24],
...
%new
- (void)handleSlideUpToUnlockPan:(UIPanGestureRecognizer *)recognizer { // unlock device with swipe up
...
- (void)handleBounceTap:(UITapGestureRecognizer *)recognizer { // bounce on tap
    ...
    [UIView animateWithDuration:0.3 delay:0 options:UIViewAnimationOptionCurveEaseOut animations:^{
        ...
        if (enableMediaPlayerSwitch) {
            CGRect diaryPlayerViewFrame = [[self diaryPlayerView] frame];
            diaryPlayerViewFrame.origin.y -= 35;
            [[self diaryPlayerView] setFrame:diaryPlayerViewFrame];
        }
...
- (void)didMoveToWindow { // add iphone hello
    ...
    if (enableHelloSwitch && showHelloGreetingSwitch && ![self diaryHelloLabel]) {
        ...
        [NSLayoutConstraint activateConstraints:@[
            [self.diaryHelloLabel.topAnchor constraintEqualToAnchor:self.topAnchor constant:130],
...
- (void)initHelloViewWithAnimation:(int)animation { // set hello view up
	...
	[NSLayoutConstraint activateConstraints:@[
		[self.diaryHelloIconView.topAnchor constraintEqualToAnchor:self.topAnchor constant:30],
...
- (void)didMoveToWindow { // add media player
    ...
    [NSLayoutConstraint activateConstraints:@[
        [self.diaryPlayerView.trailingAnchor constraintEqualToAnchor:self.diaryView.trailingAnchor],
        [self.diaryPlayerView.bottomAnchor constraintEqualToAnchor:self.diaryBatteryIcon.topAnchor constant:-24],
        [self.diaryPlayerView.heightAnchor constraintEqualToConstant:140],
        [self.diaryPlayerView.widthAnchor constraintEqualToConstant:400],
    ]];
    ...
    [NSLayoutConstraint activateConstraints:@[
        [self.diaryArtworkView.topAnchor constraintEqualToAnchor:self.diaryPlayerView.topAnchor],
    ...
    [NSLayoutConstraint activateConstraints:@[
        [self.diarySongTitleLabel.topAnchor constraintEqualToAnchor:self.diaryPlayerView.topAnchor constant:16],
    ...
    if ([fontFamilyValue intValue] == 0) [[self diaryArtistLabel] setFont:[UIFont fontWithName:@"Selawik-Regular" size:16]];
    else if ([fontFamilyValue intValue] == 1) [[self diaryArtistLabel] setFont:[UIFont fontWithName:@"OpenSans-Regular" size:16]];
    else if ([fontFamilyValue intValue] == 2) [[self diaryArtistLabel] setFont:[UIFont systemFontOfSize:16 weight:UIFontWeightRegular]];
    ...
    [NSLayoutConstraint activateConstraints:@[
        [self.diaryArtistLabel.topAnchor constraintEqualToAnchor:self.diarySongTitleLabel.bottomAnchor constant:2],
...
- (void)viewDidLoad { // add the diary passcode view
    ...
    [[self incorrectPasswordButton] setTitle:@"OK" forState:UIControlStateNormal];
