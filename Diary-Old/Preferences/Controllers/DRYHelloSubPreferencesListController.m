#import "DRYHelloSubPreferencesListController.h"

@implementation DRYHelloSubPreferencesListController
...
- (void)setPreferenceValue:(id)value specifier:(PSSpecifier*)specifier {
    ...
    if ([[specifier propertyForKey:@"key"] isEqualToString:@"enableHello"]) {
        [self respring];
    }
