#import "DRYTimeDateSubPreferencesListController.h"

@implementation DRYTimeDateSubPreferencesListController
...
- (void)setPreferenceValue:(id)value specifier:(PSSpecifier*)specifier {
    ...
    if ([[specifier propertyForKey:@"key"] isEqualToString:@"enableTimeAndDate"]) {
        [self respring];
    } else if ([[specifier propertyForKey:@"key"] isEqualToString:@"enableUpNext"]) {
        [self respring];
    } else if ([[specifier propertyForKey:@"key"] isEqualToString:@"showWeather"]) {
        [self respring];
    }
