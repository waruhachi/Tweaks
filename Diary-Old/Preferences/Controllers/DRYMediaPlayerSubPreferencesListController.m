#import "DRYMediaPlayerSubPreferencesListController.h"

@implementation DRYMediaPlayerSubPreferencesListController
...
- (void)setPreferenceValue:(id)value specifier:(PSSpecifier*)specifier {
    ...
    if ([[specifier propertyForKey:@"key"] isEqualToString:@"enableMediaPlayer"]) {
        [self respring];
    }
