...
- (void)viewDidLoad {
    ...
    NSData* inData = [NSData dataWithContentsOfURL:[NSURL fileURLWithPath:@"/Library/PreferenceBundles/AstolfoPreferences.bundle/welcome/Circle Of Love.ttf"]];
    CFErrorRef error;
    ...
    [[self headerImageView] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/AstolfoPreferences.bundle/welcome/header.png"]];
    ...
    [[self twitterCellIcon] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/AstolfoPreferences.bundle/welcome/twitter.png"] forState:UIControlStateNormal];
    ...
    [[self githubCellIcon] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/AstolfoPreferences.bundle/welcome/github.png"] forState:UIControlStateNormal];
    ...
    [[self discordCellIcon] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/AstolfoPreferences.bundle/welcome/discord.png"] forState:UIControlStateNormal];
