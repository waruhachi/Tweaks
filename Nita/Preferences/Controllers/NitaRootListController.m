#include "NitaRootListController.h"

@implementation NitaRootListController
...
- (void)viewDidLoad {
	...
	[[self iconView] setImage:[UIImage imageWithContentsOfFile:jbroot(@"/Library/PreferenceBundles/NitaPreferences.bundle/icon.png")]];
	...
	[[self headerImageView] setImage:[UIImage imageWithContentsOfFile:jbroot(@"/Library/PreferenceBundles/NitaPreferences.bundle/Banner.png")]];
