...
@interface SingleTwitterView : UIButton
...
@implementation SingleTwitterView {
	BOOL subviewsAdded;
...
@implementation DuoTwitterCell
	-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)identifier specifier:(PSSpecifier *)specifier {
		...
		if (self) {
			SingleTwitterView *leftSide = [SingleTwitterView new];
			...
			SingleTwitterView *rightSide = [SingleTwitterView new];
